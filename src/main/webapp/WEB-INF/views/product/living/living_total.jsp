                                            ...
                                            <div class="product-inner">
                                                <div class="product-image">
                                                    ...
                                                    <div class="product-action">
                                                    	...
                                                    	%>
                                                            <a href="wishlist.fu?cateEn=${dto.cateEn }&itemname=<%=str %>&price=${dto.price }&imagepath=/resources/images/livingroom/${dto.imageIndex}.jpg" class="action-btn">       
                                                                <i class="la la-heart-o"></i>
                                                            </a>
                                                        <%}else{ %>
                                                            <a href="wishlist.fu?cateEn=${dto.cateEn }&itemname=${dto.productName }&price=${dto.price }&imagepath=/resources/images/livingroom/${dto.imageIndex}.jpg" class="action-btn">       
                                                                <i class="la la-heart-o"></i>
                                                            </a>
                                                        <%} %>
