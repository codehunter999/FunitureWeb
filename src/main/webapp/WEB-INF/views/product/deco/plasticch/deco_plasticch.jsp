                                        ...
                                        <div class="ft-product">
                                            <div class="product-inner">
                                                <div class="product-image">
                                                    ...
                                                    <a href="deco_plasticch_details.fu?imageIndex=${dto.imageIndex }&cate=${dto.cate }" class="product-overlay"></a>
                                                    <div class="product-action">
                                                        <!-- <a data-toggle="modal" data-target="#productModal" class="action-btn">
                                                            <i class="la la-eye"></i>
                                                        </a> -->
                                                        <a href="wishlist.fu?cate=${dto.cate }&imageIndex=${dto.imageIndex }&price=${dto.price }&imagetype=/resources/images/deco/${dto.saveFileName}" class="action-btn">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-category">
                                                        <a href="deco_plasticch_details.fu?imageIndex=${dto.imageIndex }&cate=${dto.cate }">${dto.productName }</a>
                                                    </div>
