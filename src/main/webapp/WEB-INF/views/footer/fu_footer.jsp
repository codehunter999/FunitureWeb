                            ...
                            <div class="footer-widget">
                                <div class="textwidget">
                                    <figure class="footer-logo mb--30">
                                        <img src="<%=cp1%>/resources/assets/img/logo/logo.jpg" alt="Logo">
                                    </figure>
                                    <p><h3>작은 변화가 큰 행복을 만듭니다. </h3></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-11">
                            <div class="footer-widget">
                                <div class="taglist" style="font-size: 10pt; color: gray;">
                                    ...
                                    <a href="#">Support</a>
                                    <a href="#">Template</a> -->
                                    (주)카레클린트&nbsp;&nbsp;|&nbsp;&nbsp;대표자: 안오준 정재엽 탁의성&nbsp;&nbsp;|&nbsp;&nbsp;사업자 등록번호 안내:[211-88-75657]&nbsp;&nbsp;|&nbsp;&nbsp;통신판매업 신고 2012-서울강남-03297&nbsp;&nbsp;&nbsp;&nbsp;[사업자정보확인]<br/>
                                    대표번호: 1599-4797 A/S서비스센터: 1644-2908 서비스센터 운영시간:평일 10:00-17:00&nbsp;&nbsp;|&nbsp;&nbsp;주소: 135948 서울 강남구 청담동 3-11 개인정보관리책임자:정재엽-탁의성<br/>
