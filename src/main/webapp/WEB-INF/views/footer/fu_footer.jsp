                    ...
                    <div class="col-lg-6">
                        ...
                        >
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.fu">
                                        <img src="<%=cp1 %>/resources/assets/img/products/prod-01.jpg" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                            ...
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.fu">
                                        <img src="<%=cp1 %>/resources/assets/img/products/prod-02.jpg" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                                <span class="product-badge sale">sale</span>
                            </div>
                        ...
                        <div class="modal-box product-summary">
                            ...
                            <div class="product-footer-meta">
                                <p><span>Category:</span>
                                    <a href="shop.fu">Full Sweater</a>,
                                    <a href="shop.fu">SweatShirt</a>,
                                    <a href="shop.fu">Jacket</a>,
                                    <a href="shop.fu">Blazer</a>
                                </p>
                            </div>
                        </div>
                    </div>
