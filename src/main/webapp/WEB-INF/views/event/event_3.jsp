                    ...
                    <div class="row no-gutters mb--80 mb-md--57">
                                        ...
                                        <div class="product-gallery__wrapper">
                                            ...
                                            data-slick-options='{
                                               ...
                                               <figure class="product-gallery__image zoom">
                                                    <img src="<%=cp %>/resources/assets/img/event/e3-1.jpg" alt="Product">
                                    ...
                                    <div class="product-gallery__nav-image">
                                        ...
                                        data-slick-responsive='[
                                            ...
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/event/e3-1.jpg" alt="Products">
                                            </figure>
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/event/e3-1.jpg" alt="Products">
                                            </figure>
                        ...
                        <div class="col-xl-4 offset-xl-1 col-lg-5 product-main-details mt-md--50">
                            <div class="product-summary pl-lg--30 pl-md--0">
                                ...
                                <h3 class="product-title mb--20">601 오크 사이드 체어</h3>
                                ...
                                <div class="tab-content" id="product-tabContent">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="product-description">
                                            <p>601 오크 사이드 체어 [선브렐라]</p>                                            
                                           	<div>
                                           		<img alt="product" src="<%=cp %>/resources/assets/img/event/e3-2.jpg">
                                           	</div>
                                           	<div>
