                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            data-slick-responsive= '[
                                ...
                                <div class="item">
                                    <figure>
                                        <img src="<%=cp %>/resources/assets/img/products/prod-08-700x778.png" alt="product" class="w-100">
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure>
                                        <img src="<%=cp %>/resources/assets/img/products/prod-09-700x778.png" alt="product" class="w-100">
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure>
                                        <img src="<%=cp %>/resources/assets/img/products/prod-10-700x778.png" alt="product" class="w-100">
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure>
                                        <img src="<%=cp %>/resources/assets/img/products/prod-02-700x778.png" alt="product" class="w-100">
                                    </figure>
                                </div>
                            </div>
                            <!-- Product Slider End -->
