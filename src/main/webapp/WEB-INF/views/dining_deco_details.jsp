                                ...
                                <form action="#" class="variation-form mb--20">
                                    <div class="product-size-variations d-flex align-items-center mb--15">
                                        ...
                                        <div class="product-size-variation variation-wrapper">
                                        	...
                                        	<select>
                                            	<option selected="selected">- [리놀륨색상] 옵션을 선택해주세요 -</option>
                                    ...
                                    <div class="ft-product">
                                        <div class="product-inner">
                                            <div class="product-image">
                                                ...
                                                <a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cate=${dto.cate}" class="product-overlay"></a>
                                            ...
                                            <div class="product-info">
                                                <div class="product-category">
                                                    <a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cate=${dto.cate}">${dto.cate }</a>
                                                </div>
                                                <h3 class="product-title"><a href="dining_deco_details.fu?imageIndex=${dto.imageIndex}&cate=${dto.cate}">${dto.productName }</a></h3>
