                                            ...
                                            <div class="product-inner">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-category">
                                                        <a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex }&cate=${dto.cate }">${dto.productName }</a>
                                                    </div>
                        ...
                        >
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex }&cate=${dto.cate}">
                                        <img src="<%=cp %>/resources/images/dining/${dto.saveFileName}" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
