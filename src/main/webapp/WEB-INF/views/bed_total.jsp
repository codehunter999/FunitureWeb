...
<body>
                                                 ...
                                                 <li class="mainmenu__item menu-item-has-children megamenu-holder">
                                                    ...
                                                    <ul class="megamenu">
                                                        <li>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="<%=cp%>/living_sunb.fu?cateE=sunb">
                                                                        <span class="mm-text">★선브렐라 소파</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_fabric.fu?cateE=fabric">
                                                                        <span class="mm-text">패브릭 소파</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_leather.fu?cateE=leather">
                                                                        <span class="mm-text">가죽 소파</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_deus.fu?cateE=deus">
                                                                        <span class="mm-text">데우스 소파</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_sideTable.fu?cateE=sideTable">
                                                                        <span class="mm-text">사이드 테이블</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_TV.fu?cateE=TV">
                                                                        <span class="mm-text">TV 장</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_shelf.fu?cateE=shelf">
                                                                        <span class="mm-text">선반</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/living_bookcase.fu?cateE=bookcase">
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="<%=cp%>/bed_bed.fu?cateE=BED">
                                                                        <span class="mm-text">침대</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/bed_ht.fu?cateE=ht">
                                                                        <span class="mm-text">협탁</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/bed_dressingTable.fu?cateE=dressingTable">
                                                                        <span class="mm-text">화장대</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<%=cp%>/bed_chiff.fu?cateE=chiff">
                                        ...
                                        <div class="ft-product">
                                            <div class="product-inner">
                                                <div class="product-image">
                                                    ...
                                                    ${dto.imageIndex }
                                                    ${dto.cateE }
                                                        <img src="<%=cp %>/resources/images/bedroom/${dto.saveFileName}" alt="Product">	
                                                    </figure>
                                                    <a href="bed_${dto.cateE }_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateE }" class="product-overlay"></a>
                                                ...
                                                <div class="product-info">
                                                    <div class="product-category">
                                                        <a href="bed_${dto.cateE }_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateE }">${dto.cateK }</a>
                                                    </div>
                                                    <h3 class="product-title"><a href="bed_${dto.cateE }_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateE }">${dto.productName }</a></h3>
	...
	<input type="hidden" value="cateE"/>
	<input type="hidden" value="cateK"/>
    <!-- ************************* JS Files ************************* -->
