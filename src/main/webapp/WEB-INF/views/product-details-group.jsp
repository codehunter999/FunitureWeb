                    ...
                    <div class="row no-gutters mb--77 mb-md--57">
                                    ...
                                    <div class="product-gallery__large-image mb-sm--30">
                                        <div class="product-gallery__wrapper">
                                            ...
                                            data-slick-options='{
                                                ...
                                                <figure class="product-gallery__image zoom">
                                                    <img src="<%=cp %>/resources/assets/img/products/prod-09-700x778.png" alt="Product">
                                                    <span class="product-badge sale">Sale</span>
                                                    <div class="product-gallery__actions">
                                                        <button class="action-btn btn-zoom-popup"><i class="la la-eye"></i></button>
                                                        <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="action-btn video-popup"><i class="la la-play"></i></a>
                                                ...
                                                <figure class="product-gallery__image zoom">
                                                    <img src="<%=cp %>/resources/assets/img/products/prod-10-700x778.png" alt="Product">
                                                    <span class="product-badge sale">Sale</span>
                                                    <div class="product-gallery__actions">
                                                        <button class="action-btn btn-zoom-popup"><i class="la la-eye"></i></button>
                                                        <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="action-btn video-popup"><i class="la la-play"></i></a>
                                                ...
                                                <figure class="product-gallery__image zoom">
                                                    <img src="<%=cp %>/resources/assets/img/products/prod-04-700x778.png" alt="Product">
                                                    <span class="product-badge sale">Sale</span>
                                                    <div class="product-gallery__actions">
                                                        <button class="action-btn btn-zoom-popup"><i class="la la-eye"></i></button>
                                                        <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="action-btn video-popup"><i class="la la-play"></i></a>
                                    ...
                                    <div class="product-gallery__nav-image">
                                        ...
                                        data-slick-responsive='[
                                            ...
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-08-170x195.png" alt="Products">
                                            </figure>
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-09-170x195.png" alt="Products">
                                            </figure>
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-10-170x195.png" alt="Products">
                                            </figure>
                                            <figure class="product-gallery__nav-image--single">
                                                <img src="<%=cp %>/resources/assets/img/products/prod-04-170x195.jpg" alt="Products">
                                            </figure>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 product-main-details mt-md--50">
                            <div class="product-summary pl--30 pl-md--0">
                                ...
                                <form action="#" class="form--action mb--30">
                                        ...
                                        <table class="table group-product-table">
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Men's Fashion Comfort Genuine Leather Belt</a></h3>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Slim-fit suit blazer</a></h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$49.00</span>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Slim-fit striped cotton blazer</a></h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
                                    ...
                                    <div class="product-action">
                                        <a href="cart.html" class="btn btn-size-sm btn-shape-square">
                                            Add To Cart
                                        </a>
                                    </div>  
                                </form>
