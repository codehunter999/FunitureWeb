                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>${dto.cateE }</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                     ...
                                     <%--    <c:forEach items="" var=""></c:forEach>
                                      <c:forEach items="" var="dto"> --%>
                                            <figure class="product-gallery__nav-image--single">
                                                <a href="dining_sunbrella_details.fu?imageIndex=${dto.imageIndex }&cateE=${dto.cateE}">
                                                	<img src="<%=cp %>/resources/images/bedroom/${dto.saveFileName}" alt="Products">
                                                </a>
                                            </figure>
                                  <%--     </c:forEach> --%>
                                        </div>
                                            ...
                                            <table class="table shop_attributes">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Color</th>
                                                        <td>
                                                            <a href="shop.jsp">Black</a>,
                                                            <a href="shop.jsp">Gray</a>,
                                                            <a href="shop.jsp">Red</a>,
                                                            <a href="shop.jsp">Violet</a>,
                                                            <a href="shop.jsp">Yellow</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="ft-product">
                                        <div class="product-inner">
                                            <div class="product-image">
                                                ...
                                                <a href="product-details.jsp" class="product-overlay"></a>
                                            ...
                                            <div class="product-info">
                                                <div class="product-category">
                                                    <a href="product-details.jsp">Chair</a>
                                                </div>
                                                <h3 class="product-title"><a href="product-details.jsp">Golden Easy Spot Chair.</a></h3>
