                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>Blog Left Sidebar</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <article class="blog format-standard">
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <figure class="image">
                                                    <img src="<%=cp %>/resources/assets/img/blog/blog-06.jpg" alt="Blog" class="w-100">
                                        ...
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <div class="element-carousel" data-slick-options='{
                                                    ...
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-07.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div> 
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-08.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div> 
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-09.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div>                 
                                                </div>
                                            </div>
                                ...
                                <div class="col-12 mb--45">
                                    <article class="blog">
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <figure class="image">
                                                    <img src="<%=cp %>/resources/assets/img/blog/blog-09.jpg" alt="Blog" class="w-100">
                                                    <a href="blog-details-image.html" class="item-overlay"></a>
                                                </figure>
                                            </div>
                                            <div class="blog__info">
                        ...
                        <div class="col-lg-3 order-lg-1">
                            <div class="blog-sidebar pr--15 pr-lg--0">
                                <div class="bl-widget author">
                                    <div class="inner">
                                        <div class="thumb">
                                            <img src="<%=cp %>/resources/assets/img/others/team-04.jpg" alt="Author Images">
                                        </div>
                                        <div class="info">
