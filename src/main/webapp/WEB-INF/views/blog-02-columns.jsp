            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Blog 02 Columns</h1>
                        <ul class="breadcrumb">
                                    ...
                                    <article class="blog format-standard">
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <figure class="image">
                                                    <img src="<%=cp %>/resources/assets/img/blog/blog-06-560x345.jpg" alt="Blog Image" class="w-100">
                                            ...
                                            <div class="blog__info">
                                                ...
                                                <div class="blog__desc">
                                                    <p>Financial services must tie these three factors together â customer experience, best practices and reliability</p>
                                                </div>
                                        ...
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <div class="element-carousel" data-slick-options='{
                                                    ...
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-07-560x345.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div> 
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-08-560x345.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div> 
                                                    <div class="item">
                                                        <img src="<%=cp %>/resources/assets/img/blog/blog-09-560x345.jpg" alt="Blog Image" class="w-100">
                                                        <a href="blog-details-image.html" class="item-overlay"></a>
                                                    </div>                 
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6 mb--50">
                                    <article class="blog">
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <figure class="image">
                                                    <img src="<%=cp %>/resources/assets/img/blog/blog-10-560x345.jpg" alt="Blog" class="w-100">
                                                    <a href="blog-details-image.html" class="item-overlay"></a>
                                                </figure>
                                            </div>
                                            <div class="blog__info">
                                ...
                                <div class="col-lg-6 mb--50">
                                    <article class="blog">
                                        <div class="blog__inner">
                                            <div class="blog__media">
                                                <figure class="image">
                                                    <img src="<%=cp %>/resources/assets/img/blog/blog-11-560x345.png" alt="Blog" class="w-100">
                                                    <a href="blog-details-image.html" class="item-overlay"></a>
                                                </figure>
                                            </div>
                                            <div class="blog__info">
